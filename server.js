...
"REGRA DE OURO 1B: BUVA vs LOSNA-BRANCA E UM CASO DIFICIL — a diferenca de profundidade de recorte na folha pode ser sutil e nao e 100% confiavel sozinha (buva pode ter folha bem serrilhada tambem). O traco REALMENTE decisivo entre essas duas e a INFLORESCENCIA: buva=capitulos pequenos esbranquicados/creme que viram pluma/pappus algodonoso; losna=capitulos brancos pequenos SEMIGLOBOSOS distintos. Se a foto NAO mostra claramente a flor/inflorescencia DA PROPRIA planta em foco, NAO escolha uma das duas como se tivesse certeza — mas TAMBEM NAO retorne generico 'Nao identificado' (essas sao 2 pragas MUITO comuns em lavoura de cafe, e o produtor precisa de uma resposta util). Em vez disso: use \"nome\":\"Buva ou Losna-branca (folhas parecidas — confirme pela flor)\", confianca 'media', 'grupo':'folha_larga', e no campo 'acao' explique a diferenca visual das flores das duas e recomende observar/fotografar a flor para confirmar; inclua nos 'produtos' as opcoes de controle das DUAS (Galigan/Heat para buva, Ametrina/2,4-D para losna), identificando qual produto e para qual planta no campo 'como_usar'. So use \"Nao identificado com certeza\" quando a planta genuinamente NAO se parecer com NENHUMA especie da lista (nao apenas quando houver duvida entre duas conhecidas).\n"+
...
"4. BUVA/VOADEIRA (Conyza bonariensis / C. sumatrensis / C. canadensis): FOLHA LARGA de folha ESTREITA. ERETA 0,5-2m, caule UNICO ROLICO (redondo, NAO triangular), estriado e piloso, pouco ramificado (ramos so proximos ao apice). Folhas NUMEROSAS, estreito-lanceoladas (compridas e finas), alternadas, cobrindo densamente o caule de baixo para cima. MARGEM da folha pode variar de LISA ate BEM DENTEADA/SERRILHADA (dentes irregulares na borda) dependendo da especie — ISSO E NORMAL EM BUVA. O que importa NAO e se tem dentes, e sim ATE ONDE o recorte vai: nos dentes da buva, o LIMBO CONTINUA INTEIRO E CONECTADO no meio da folha (os dentes ficam so na beirada, tipo uma serra, sem separar a folha em pedacos). Panicula terminal com capitulos pequenos esbranquicados/creme que viram PAPPUS algodonoso. CONTRASTE COM LOSNA-BRANCA: em buva, mesmo com dentes fortes, a folha e UMA PECA SO (recorte so na margem); em losna-branca, os recortes vao fundo, quase ate a nervura central, dividindo a folha em segmentos como se fossem varias folhinhas (aspecto de samambaia/salsa). Se estiver em duvida entre as duas E SO A FOLHA estiver visivel (sem flor), use confianca 'media' e mencione as duas possibilidades no campo 'acao', pedindo foto da flor para confirmar. Solo de plantio direto, resistencia a glifosato comum. Galigan 240EC 3L/ha, Heat 700WG 70-100g/ha (glifosato sozinho falha).\n"+
