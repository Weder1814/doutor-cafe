...
"1. Ao citar um produto pela primeira vez em cada campo, use o formato 'Nome Generico (Nome Comercial)' — ex: 'Tebuconazol (Folicur)' — nunca so o nome comercial isolado, pois o produtor pode ter uma marca diferente com o mesmo generico.\n"+
...
"No campo 'acao', use linguagem simples para produtor leigo: cite nome generico junto do comercial na primeira mencao, e explique rapidamente (3-6 palavras) qualquer termo tecnico como K2O/P2O5, calda, fertirrigacao, carencia, pos-emergencia.\n\n"+
"RESPONDA SOMENTE JSON:\n"+
