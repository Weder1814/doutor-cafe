...
"TESTE DECISIVO (use SEMPRE): (1) As folhas saem ao longo de um caule que sobe, alternadas/opostas? => FOLHA LARGA (grupo A), mesmo que as folhas sejam estreitas. (2) As folhas saem todas da base? entao veja o caule: triangular = TIRIRICA (C); redondo com nos = CAPIM (B). (3) A MARGEM da folha tem dentes/recortes/serrilhado visivel (irregular, nao lisa)? Capim e tiririca SEMPRE tem margem LISA/inteira — margem denteada ou recortada so existe em folha larga (ex: buva, picao-preto). Se ver dentes na borda da folha, DESCARTE capim e tiririca imediatamente.\n"+
...
"4. BUVA/VOADEIRA (Conyza spp. / Erigeron): FOLHA LARGA de folha ESTREITA. ERETA 0,5-2m, caule UNICO ROLICO (redondo, NAO triangular), piloso. Folhas ESTREITAS e ALONGADAS dispostas em ESPIRAL subindo o caule (muito numerosas, quase uma 'coroa' densa no topo), com margem PROFUNDAMENTE RECORTADA/SERRILHADA em dentes grandes e irregulares (aspecto DENTEADO ou quase pinatifido, como um pente ou serra — NAO e serrilhado fraco/liso). No topo ou nas axilas, pequenas flores esbranquicadas/creme em paniculas ramificadas que viram PAPPUS algodonoso. CONTRASTE COM TIRIRICA/CAPIM: buva tem UM caule central com folhas em espiral subindo (nao touceira na base), margem da folha denteada de forma irregular e profunda (capins tem margem LISA/inteira; tiririca tambem tem margem lisa). Se a folha tem dentes/recortes profundos e irregulares na borda, e BUVA (folha larga), NUNCA capim ou tiririca (que tem margem sempre lisa). Solo de plantio direto, resistencia a glifosato comum. Galigan 240EC 3L/ha, Heat 700WG 70-100g/ha (glifosato sozinho falha).\n"+
...
"6. TIRIRICA (Cyperus rotundus): JUNCA (Cyperaceae). BAIXA 15-40cm, folhas estreitas BRILHANTES saindo TODAS DA BASE em TRES FILEIRAS, caule MACICO e TRIANGULAR (3 lados) ao corte, inflorescencia em umbela com espiguetas marrom-avermelhadas, raizes com TUBERCULOS/rizomas. CONTRASTE: se a planta e ALTA com folhas ALTERNADAS subindo por um caule, NAO e tiririca (provavelmente buva). So classifique como tiririca se as folhas saem da BASE em 3 fileiras E/OU o caule e triangular. Solo com DRENAGEM RUIM ou encharcado. Glifosato + Diuron, dificil por causa dos tuberculos.\n"+
...
"13. POAIA-BRANCA / ERVA-QUENTE (Richardia brasiliensis / Spermacoce): RASTEIRA a semi-ereta, folhas OPOSTAS lanceoladas ASPERAS (pilosas) sem bainha, flores BRANCAS pequenas em ESTRELA (4-6 petalas) agrupadas nas pontas dos ramos. CONTRASTE COM TRAPOERABA: aqui a flor e BRANCA e nao ha bainha nem suculencia; trapoeraba tem flor AZUL e bainha. Indica solo compactado/acido. 2,4-D, Glifosato pos-emergencia precoce.\n"+
"14. BELDROEGA (Portulaca oleracea): RASTEIRA SUCULENTA, caule avermelhado grosso e carnudo, folhas pequenas em forma de COLHER (espatuladas) carnudas brilhantes, flores AMARELAS pequenas. Solo fertil e adubado. Glifosato, dificil por rebrota de fragmentos.\n"+
"15. LEITEIRO / AMENDOIM-BRAVO (Euphorbia heterophylla): ERETA 30-80cm, solta LATEX BRANCO (leite) ao quebrar, folhas variaveis (algumas com mancha clara na base parecendo folha de poinsettia), inflorescencia pouco vistosa. Solo fertil. Glifosato, 2,4-D; resistencia comum.\n"+
"16. GRAMA-SEDA / GRAMA-BERMUDA (Cynodon dactylon): CAPIM perene ESTOLONIFERO rasteiro que forma tapete denso, folhas curtas cinza-esverdeadas, inflorescencia em 3-6 racemos digitados finos. Espalha por estolões e rizomas. Glifosato repetido.\n\n"+
...
"REGRA FINAL: Só use confianca 'alta' se o TRACO DECISIVO daquela especie estiver VISIVEL e confirmado na foto (ex: tiririca => folhas da base em 3 fileiras OU caule triangular, margem lisa; buva => folhas em espiral no caule com margem denteada/recortada irregular + pappus; trapoeraba => flor azul/bainha; poaia => flor branca). Se o traco decisivo NAO aparece, use no maximo 'media'. Se a planta nao corresponde CLARAMENTE a nenhuma especie da lista, use \"nome\":\"Nao identificado com certeza\", confianca 'baixa', e no campo 'acao' peca uma foto mais proxima e nitida da planta inteira (folha, caule e base) — NAO escolha a especie mais parecida so para preencher. Preencha 'grupo' com o grupo que voce viu (folha_larga|capim|junca|indefinido) e 'visto' com os tracos concretos observados.\n\n"+
