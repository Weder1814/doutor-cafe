...
"CADA NUTRIENTE TEM O SEU CORRETIVO — NAO GENERALIZE O CALCARIO (corrigido 06/09/2026 apos erro real). Caso ocorrido: o diagnostico trouxe POTASSIO + MAGNESIO e o plano mandou 'aplicar a dose exata de calcario dolomitico calculada para corrigir o potassio'. Calcario dolomitico contem CALCIO e MAGNESIO — nao contem potassio nenhum. O produtor compraria calcario, aplicaria, e o potassio continuaria deficiente. Use SEMPRE o corretivo que de fato fornece o nutriente:\n"+
"- CALCIO -> calcario (calcitico ou dolomitico); gesso agricola em profundidade.\n"+
"- MAGNESIO -> calcario DOLOMITICO (via solo) ou sulfato de magnesio (foliar/solo).\n"+
"- POTASSIO -> cloreto de potassio (KCl) ou sulfato de potassio. NUNCA calcario.\n"+
"- NITROGENIO -> ureia, sulfato de amonio ou nitrato de amonio. NUNCA calcario.\n"+
"- FOSFORO -> superfosfato simples/triplo, MAP ou termofosfato. NUNCA calcario.\n"+
"- BORO -> borax, acido borico ou ulexita. ZINCO -> sulfato de zinco. FERRO -> sulfato ferroso ou quelato.\n"+
"Quando o diagnostico trouxer MAIS DE UMA deficiencia, trate cada uma com o seu proprio corretivo e deixe claro no texto qual produto resolve qual nutriente. A calagem pode ser citada como pratica que MELHORA a absorcao geral (corrigindo o pH), mas NUNCA como a forma de FORNECER potassio, nitrogenio ou fosforo.\n\n"+
...
function buildContextoRegional(regiao, altitude, isVideo, especieEscolhida) {
  ...
  "Planalto da Bahia":"clima seco favorece acaro vermelho. Deficiencia de Ferro em solos alcalinos. Especie predominante: Coffea arabica.",
      ...
      "Espirito Santo":"regiao MISTA: no norte, areas baixas e quentes sao Conilon Capixaba (Coffea canephora, CLONAL — variedades clonais ja sao mais de 60% do parque cafeeiro do estado, entao clones diferentes convivem no mesmo talhao com resistencias diferentes) — la corynespora e relevante (descrita em Castelo-ES), mancha manteigosa e comum, escaldadura por sol pesa muito em alguns clones e a broca merece atencao redobrada. Colheita do conilon e mais precoce que a do arabica (variedades precoces como a Diamante Incaper 8112 colhem ja em maio). Nas montanhas do sul (Brejetuba, Iuna) predomina Coffea arabica, com ferrugem e cercosporiose. Considere a altitude e o municipio antes de assumir a especie.",
