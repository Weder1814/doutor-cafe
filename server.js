...
"TESTE DECISIVO (use SEMPRE): (1) As folhas saem ao longo de um caule que sobe, alternadas/opostas? => FOLHA LARGA (grupo A), mesmo que as folhas sejam estreitas. (2) As folhas saem todas da base? entao veja o caule: triangular = TIRIRICA (C); redondo com nos = CAPIM (B).\n"+
...
"4. BUVA/VOADEIRA (Conyza spp. / Erigeron): FOLHA LARGA de folha ESTREITA. ERETA 0,5-2m, caule UNICO ROLICO (redondo, NAO triangular), folhas ESTREITAS lanceoladas ALTERNADAS subindo ao longo do caule (NAO saem da base), muitas vezes com pelos e leve serrilhado. No topo, muitas flores pequenas esbranquicadas/creme que viram PAPPUS algodonoso (sementes que voam). CONTRASTE COM TIRIRICA: buva e alta, folhas alternadas no caule, caule redondo; tiririca e baixa, folhas da base em 3 fileiras, caule triangular. Solo de plantio direto, resistencia a glifosato comum. Galigan 240EC 3L/ha, Heat 700WG 70-100g/ha (glifosato sozinho falha).\n"+
